...
import Matematica from "../../../components/common/Matematica/index";
...
interface MatematicasPageProps {
    userData?: UserData | null;
}

export default function MatematicasPage({ userData }: MatematicasPageProps) {
